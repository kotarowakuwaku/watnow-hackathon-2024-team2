...
import styelss from "./page.module.css";
  ...
  const getFavorite = async (data: { oshi_name: string; email: string }) => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/content/fetch-content`,
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        const sortedContent = responseData.content.sort(
  ...
  return (
    <div style={styles.container as React.CSSProperties}>
      {isLoading ? (
        ...
        >
          <div className={styelss.loadingDonut}></div>
          {""}
            ...
            if (item.type === "text") {
              return (
                <div
                  ...
                  style={{
                    textAlign:
                      item.alignment as React.CSSProperties["textAlign"],
              ...
              return (
                <div
                  key={index}
                  style={styles.snsContainer as React.CSSProperties}
                >
                  {item.snsLinks &&
